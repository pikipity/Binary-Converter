...
def Floating_and_decimal_window():
    ...
    Floating_and_decimal_toplevel.title(u"�����ȸ���ת��")
    Floating_and_decimal_toplevel.iconbitmap("bitmap\\binary.ico")
    
    decimal_label=Tkinter.Label(Floating_and_decimal_toplevel,text=u"ʮ����: ",\
                               font="Times 23 bold")
    ...
    Convert_button=Tkinter.Button(Floating_and_decimal_toplevel,text=u"ת��",\
                               font="Times 23 bold",\
                                  width=17,command=Floating_and_decimal_function)
    Convert_button.grid(row=1,column=1,columnspan=1)

    Clear_button=Tkinter.Button(Floating_and_decimal_toplevel,text=u"����",\
                                font="Times 23 bold",\
                                width=5,command=Clear_Function)
    Clear_button.grid(row=1,column=2,columnspan=2)

    bin_label=Tkinter.Label(Floating_and_decimal_toplevel,text=u"������: ",\
                               font="Times 23 bold")
...
def Floating_and_decimal_function():
    ...
    if(decimal_decision==1 and bin_decision==1):
        tkMessageBox.showwarning(u"��������",u"��Ҫ�����!!")
    elif(decimal_decision==0 and bin_decision==0):
        tkMessageBox.showwarning(u"��������",u"��Ҫɶ������!!")
        ...
        for i in bin_num:
            if(i<>'0' and i<>'1'):
                ...
                break
        if(bin_not_num==1):
            tkMessageBox.showwarning(u"��������",u"��Ҫˣ�ң�������������")
        elif(len(bin_num)<>32):
            tkMessageBox.showwarning(u"��������",u"�����Ʊ���32 bit!!")
        else:
       ...
       if(decimal_not_num==1):
           tkMessageBox.showwarning(u"��������",u"��Ҫˣ�ң�����ʮ������")
       elif(mantissa_num=='0'):
           bin_num_entry.delete(0,'end')
...
def hex_2_two_window():
    ...
    hex_2_two_toplevel.title(u"ʮ��������������ת��")
    hex_2_two_toplevel.iconbitmap("bitmap\\binary.ico")
    
    hex_label=Tkinter.Label(hex_2_two_toplevel,text=u"ʮ������: ",\
                               font="Times 23 bold")
    ...
    Convert_button=Tkinter.Button(hex_2_two_toplevel,text=u"ת��",\
                               font="Times 23 bold",\
                                  width=17,command=hex_2_two_function)
    Convert_button.grid(row=1,column=1,columnspan=1)

    Clear_button=Tkinter.Button(hex_2_two_toplevel,text=u"����",\
                                font="Times 23 bold",\
                                width=5,command=hex_2_two_Clear_Function)
    Clear_button.grid(row=1,column=2,columnspan=2)

    bin_label=Tkinter.Label(hex_2_two_toplevel,text=u"������: ",\
                               font="Times 23 bold")
    bin_label.grid(row=2,column=0)
...
def hex_2_two_function():
    ...
    if(len(HexNumber)<>0 and len(BinNumber)<>0):
        tkMessageBox.showwarning(u"��������",u"��Ҫɶ���������֪��ת��˭ô��")
    elif(len(HexNumber)==0 and len(BinNumber)==0):
        tkMessageBox.showwarning(u"��������",u"ɶ�����䣿")
    elif(len(HexNumber)<>0 and len(BinNumber)==0):
        wrong=0
        try:
            ...
            wrong=1
        if(wrong==1):
            tkMessageBox.showwarning(u"��������",u"��������ȷʮ��������")
        else:
        ...
        try:
            ...
            wrong=1
        if(wrong==1):
            tkMessageBox.showwarning(u"��������",u"��������ȷ��������")
        else:
...
def hex_2_ten_window():
    ...
    hex_2_ten_toplevel.title(u"ʮ��������ʮ����ת��")
    hex_2_ten_toplevel.iconbitmap("bitmap\\binary.ico")
    
    hex_label=Tkinter.Label(hex_2_ten_toplevel,text=u"ʮ������: ",\
                               font="Times 23 bold")
    hex_label.grid(row=0,column=0)
    ...
    Convert_button=Tkinter.Button(hex_2_ten_toplevel,text=u"ת��",\
                               font="Times 23 bold",\
                                  width=17,command=hex_2_ten_function)
    Convert_button.grid(row=1,column=1,columnspan=1)

    Clear_button=Tkinter.Button(hex_2_ten_toplevel,text=u"����",\
                                font="Times 23 bold",\
                                width=5,command=hex_2_ten_Clear_Function)
    Clear_button.grid(row=1,column=2,columnspan=2)

    bin_label=Tkinter.Label(hex_2_ten_toplevel,text=u"ʮ����: ",\
                               font="Times 23 bold")
    bin_label.grid(row=2,column=0)
...
def two_2_ten_window():
    ...
    two_2_ten_toplevel.title(u"��������ʮ����ת��")
    two_2_ten_toplevel.iconbitmap("bitmap\\binary.ico")
    
    two_label=Tkinter.Label(two_2_ten_toplevel,text=u"������: ",\
                               font="Times 23 bold")
    ...
    Convert_button=Tkinter.Button(two_2_ten_toplevel,text=u"ת��",\
                               font="Times 23 bold",\
                                  width=17,command=two_2_ten_function)
    Convert_button.grid(row=1,column=1,columnspan=1)

    Clear_button=Tkinter.Button(two_2_ten_toplevel,text=u"����",\
                                font="Times 23 bold",\
                                width=5,command=two_2_ten_Clear_Function)
    Clear_button.grid(row=1,column=2,columnspan=2)

    ten_label=Tkinter.Label(two_2_ten_toplevel,text=u"ʮ����: ",\
                               font="Times 23 bold")
...
def AboutUs_Open():
    ...
    TitleLabel=Tkinter.Label(AboutUs,text=u"����ת����",\
...
pikipityw@gmail.com"""\
    ...
    ContentLabel=Tkinter.Message(AboutUs,text=u"""��������ʲô���⣬����ϵ�ң�лл""",font="Times 13 bold",fg="#CD5C5C",width=600)
